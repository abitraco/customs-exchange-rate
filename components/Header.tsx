...
const Header: React.FC<HeaderProps> = ({ activeType, onTypeChange, language, onLanguageChange, labels }) => {
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        <div className="flex w-full md:w-auto gap-2">
                            <button
                                ...
                                className={`flex-1 md:flex-none inline-flex justify-center items-center px-3 py-2 border rounded-md text-sm font-medium transition-colors duration-150 ${
                                    activeType === RateType.IMPORT
